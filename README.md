...
| `exams.json` | 4 đề thi JLPT thật (7/2021, 7/2022, 12/2022, 7/2023) — 241 câu có đáp án, riêng đề 7/2021 đủ cả 101 câu. **File thành phẩm, sinh ra bởi `tools/build_exams.py`** |
